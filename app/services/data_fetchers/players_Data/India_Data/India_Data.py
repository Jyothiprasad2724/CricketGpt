...
def fetch_players(country_code="IND", comp="T", current="F", sort="Name"):
...
def save_country_format_data():
    ...
    for country in country_codes:
        for comp_code, format_name in comp_format_map.items():
            ...
            if not df.empty:
                filename = f"app\services\data_fetchers\players_Data\India_Data\{country.lower()}_{format_name}.csv"
